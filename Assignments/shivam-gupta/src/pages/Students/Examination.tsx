...
export default function Examination() {
  ...
  const APPLY_DRAFT_KEY = "exam_apply_draft_v1";

  useEffect(() => {
    const saved = localStorage.getItem(APPLY_DRAFT_KEY);
    if (saved) {
      const data = JSON.parse(saved);

      setExamType(data.examType || "Semester");
  ...
  const saveDraft = () => {
    if (!examType || !semester) {
      alert("Please select exam type and semester before saving draft.");
      return;
    }
  ...
  const proceedPayment = () => {
    if (!examType || !semester) {
      alert("Please select exam type and semester.");
      return;
    }
        ...
        <div className={styles.page}>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.btnRow}>
              <button className={styles.payBtn} onClick={proceedPayment}>
                Proceed to Payment
              </button>

              <button className={styles.draftBtn} onClick={saveDraft}>
                Save as Draft
              </button>
            </div>
          </div>
        ...
        <div className={styles.admit_page}>
          ...
          <div className={styles.admit_card}>
            ...
            <div className={styles.admit_center}>
              ...
              <h4 className={styles.admit_subjectHeading}>Subjects (5)</h4>
      ...
      {subTab === "Results" && (
        <div className={styles.result_page}>
          ...
          <div className={styles.result_card}>
            ...
            {/* SUBJECT TABLE */}
            <h3 className={styles.result_sectionTitle}>
              ...
              <tbody>
                {resultSubject.map((s, i) => (
                  <tr key={i}>
                    ...
                    <td>{s.marks}</td>
                    <td>
                      <span className={styles.result_gradeBadge}>
                        {s.grade}
                      </span>
                    </td>
                    <td>{s.gp}</td>
